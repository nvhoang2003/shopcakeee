...
{{--            <a href="#" class="search-switch"><img src="{{asset('css1/img/icon/search.png')}}" alt=""></a>--}}
{{--            <a href="#"><img src="{{asset('css1/img/icon/heart.png')}}" alt=""></a>--}}
{{--        </div>--}}
{{--        <div class="offcanvas__cart__item">--}}
{{--            <a href="#"><img src="{{asset('css1/img/icon/cart.png')}}" alt=""> <span>0</span></a>--}}
{{--            <div class="cart__price">Cart: <span>$0.00</span></div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="offcanvas__logo">--}}
{{--        <a href="./index.html"><img src="{{asset('css1/img/logo.png')}}" alt=""></a>--}}
{{--    </div>--}}
